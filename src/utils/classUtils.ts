export function getStaticField<T>(instance: object, fieldName: string): T | undefined {
    if (fieldName in instance) return (instance as any)[fieldName] as T;
...
export function copyClassWithStatics<T extends typeof Object>(SourceClass: T, customStatics?: Record<string, any>): T {
