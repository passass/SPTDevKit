...
import { inject, ref, watch, computed, triggerRef, toValue, nextTick, defineComponent, type Component } from "vue";
...
function handleNavigate(key: any) {
    ...
    frameNavigator?.navigate?.(key, vnodes.value);
}
